...
| `database-architect`    | Schema, migrations, queries, policies RLS | ❌ UI, API logic, service_role_key no frontend          |
...
| `product-owner`         | Definir caminhos de arquivos, JSON DTOs   | ❌ Tomar decisões de prioridade de negócio sem o PM.    |
